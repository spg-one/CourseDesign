...
#ifdef CONFIG_TQ2440_IRQ_BUTTON
...
#endif /* CONFIG_TQ2440_IRQ_BUTTON */
...
static struct s3c2410fb_display tq2440_lcd_cfg __initdata = {
...
#elif defined(CONFIG_FB_S3C24X0_NT320240)
	.width			= 320,
	.height			= 240,
	...
	.right_margin	= 12,	/* for HBPD*/
	.hsync_len		= 58,	/* for HSPW*/
	.upper_margin	= 9,	/* for VFPD*/
	.lower_margin	= 2,	/* for VBPD*/
	.vsync_len		= 4,	/* for VSPW*/
...
#elif defined(CONFIG_FB_S3C24X0_TFT800480TN92)
	.width			= 800,
	.height			= 480,
	...
	.yres			= 480,
	.bpp			= 16,
	.left_margin	= 36,	/* for HFPD*/
	.right_margin	= 26,	/* for HBPD*/
	.hsync_len		= 20,	/* for HSPW*/
	.upper_margin	= 16,	/* for VFPD*/
	.lower_margin	= 9,	/* for VBPD*/
	.vsync_len		= 7,	/* for VSPW*/
