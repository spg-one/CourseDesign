...
//#include <mach/audio.h>//HJ 20130409
#include <plat/audio.h>//HJ 20130409
#include <asm/dma.h>
#include <mach/dma.h>

//#include <asm/plat-s3c24xx/regs-iis.h>
#include <plat/regs-iis.h>//HJ 20130409
			       ...
			       struct snd_soc_dai *dai)
{
	int ret = 0;
#if 1
	struct snd_soc_pcm_runtime *rtd = substream->private_data;	//HJ 20130409
	int channel = ((struct s3c24xx_pcm_dma_params *)
		  rtd->dai->cpu_dai->dma_data)->channel;	//HJ 20130409
#endif
...
#if 1
		s3c2410_dma_ctrl(channel, S3C2410_DMAOP_STARTED);	//HJ 20130409
#endif
		break;
