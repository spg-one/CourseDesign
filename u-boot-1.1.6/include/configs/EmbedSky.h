...
#define CONFIG_RELOCATE_NK					//WinCE解析，新添加的功能
#define CONFIG_WINCE_NK						//WinCE烧写，
#define CONFIG_EMBEDSKY_OSTYPE			"linux"	//启动为Linux或WinCE
#define CONFIG_NO_TOC					0	//1不使用TOC，0使用TOC
#ifdef CONFIG_USB_DEVICE
#define CONFIG_EMBEDSKY_YAFFS				//Yaffs烧写，
#endif
...
#elif(LCD_TFT == NT35)
#define	CONFIG_EMBEDSKY_LCD_VBPD		7
#define	CONFIG_EMBEDSKY_LCD_VFPD		6
#define	CONFIG_EMBEDSKY_LCD_VSPW		5
#define	CONFIG_EMBEDSKY_LCD_HBPD		25
#define	CONFIG_EMBEDSKY_LCD_HFPD		8
#define	CONFIG_EMBEDSKY_LCD_HSPW		42
...
#define	CONFIG_EMBEDSKY_LCD_VBPD		13
#define	CONFIG_EMBEDSKY_LCD_VFPD		8
#define	CONFIG_EMBEDSKY_LCD_VSPW		8
#define	CONFIG_EMBEDSKY_LCD_HBPD		32
#define	CONFIG_EMBEDSKY_LCD_HFPD		18
#define	CONFIG_EMBEDSKY_LCD_HSPW		12
#define	CONFIG_EMBEDSKY_LCD_CLKVAL		2
#define LCD_XSIZE_TFT				 	(800)	
#define LCD_YSIZE_TFT				 	(480)

#elif(LCD_TFT == TFT800600)
#define	CONFIG_EMBEDSKY_LCD_VBPD		14
#define	CONFIG_EMBEDSKY_LCD_VFPD		8
#define	CONFIG_EMBEDSKY_LCD_VSPW		7
#define	CONFIG_EMBEDSKY_LCD_HBPD		32
#define	CONFIG_EMBEDSKY_LCD_HFPD		18
#define	CONFIG_EMBEDSKY_LCD_HSPW		12
#define	CONFIG_EMBEDSKY_LCD_CLKVAL		1
...
#if 0
#define NO_PRINTF_BAD_BLOCK						//不打印坏块信息。
#else
#undef NO_PRINTF_BAD_BLOCK						//打印坏块信息。
#endif
...
#define CONFIG_TQ2440_NAND_HWECC		1	// Hardware ECC
